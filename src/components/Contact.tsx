...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-24 bg-primary relative border-t border-white/5"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-accent font-semibold tracking-[2px] uppercase text-[10px] mb-3">
              Get In Touch
            </h2>
            <h3 className="text-4xl md:text-5xl font-heading font-bold mb-6 leading-[0.9] tracking-[-1px] uppercase">
              We're Here to Help
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            ...
            <h4 className="text-[0.85rem] uppercase tracking-[1px] font-heading font-bold mb-2">
              Call Us
            </h4>
          ...
          >
            ...
            <p className="text-muted-foreground text-[11px]">
              hello@impactgraphics.com
            </p>
            <p className="text-muted-foreground text-[11px]">
              support@impactgraphics.com
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">Akwa</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between p-8 bg-muted rounded-none border border-border">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h4 className="text-[1.2rem] font-heading font-bold mb-2 uppercase tracking-[-0.5px]">
              Need an immediate response?
            </h4>
            <p className="text-muted-foreground text-[11px] uppercase tracking-[1px]">
              Our WhatsApp support team is online 24/7.
            </p>
          </div>

          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/237696277335"
              target="_blank"
              rel="noreferrer"
